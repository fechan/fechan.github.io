...
In the following example, the metatopic is Darmok, marked with the second person topic (<small-caps>TOP.2</small-caps>) morpheme, **a**. The rest of the sentence comments on Darmok's location in the metaphor:
